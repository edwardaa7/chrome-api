# chrome-api - A lightweight Javascript rendering service using Google Chrome browser's <a href="https://developers.google.com/web/updates/2017/04/headless-chrome">headless mode</a>.
